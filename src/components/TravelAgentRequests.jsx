...
export function TravelAgentRequests() {
  ...
  useEffect(() => {
    const fetchTravelRequests = async () => {
      try {
        const response = await axios.get(`http://localhost:9090/api/v1/travel-agent-requests`, {
          params: {
  ...
  const handleApproval = async (requestId, status) => {
    ...
    try {
      await axios.put(`http://localhost:9090/api/v1/travel-agent-requests/${requestId}`, {
...
export default TravelAgentRequests;
